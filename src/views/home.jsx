        ...
        <div>
            ...
            <div class="sub-centered-container">
                <div class="sub-centered-inner-container">
                    <div class="sub-image-container">
                        <img src="/Images/Dental/5.png" alt="Image description"></img>
                    </div>
                    <div class="sub-text-container">
                        <h2 class="brown cen">A Journey to Transformative Smiles</h2>
            ...
            <div class="sub-centered-container">
                <div class="sub-centered-inner-container">
                    ...
                    <div class="sub-text-container">
                        <h2 class="gold">Patient-Centric Excellence</h2>
                    ...
                    <div class="sub-image-container">
                        <img src="/Images/Dental/3.png" alt="Image description"></img>
                    </div>
                </div>
            </div>
            &nbsp;
            <div class="sub-centered-container">
                <div class="sub-centered-inner-container">
                    ...
                    <div class="sub-text-container">
                        <h2 class="brown cen">Innovation and Technology</h2>
                        <p class="lead text-start center ">We embrace innovation and leverage cutting-edge technology to provide state-of-the-art dental
                         ...
                         <button class="crown-button">Read More</button>
                    </div>
                </div>
            </div>
            &nbsp;
            ...
            <div class="crown-container">
                    <div class="crown-inner-container">
                        <div class="crown-text-container">
                            <h2 class="brown">Meet Our Dental Artists</h2>
                            <p class="lead text-start center ">
                            Our team at ASH Dental is a collective of skilled professionals, each bringing a unique set of expertise
