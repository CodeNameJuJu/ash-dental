            ...
            <div className='pt-4 mt-3 pb-3 ps-4 ms-4 pe-4 me-4'>
             <div className='text-center ps-4 ms-4 pe-4 me-4' >
                    ...
                    <div className='d-flex flex-column justify-content-center'>
                        <p className="lead col-8 text-start ">Redefine smiles and enhance the natural beauty of your teeth. Cosmetic dentistry goes beyond
                        ...
                        <br></br>
                        <p className="lead col-8 text-start">Whether you desire a whiter, straighter, or more aesthetically
                        ...
                        <br></br>
                        <p className="lead col-8 text-start">The benefits of cosmetic dentistry extend beyond appearance, positively impacting your confidence,
                ...
                <div class="serv3-image-grid">
                    <div class="serv3-image-block">
                        ...
                        <div class="serv3-content-details fadeIn-bottom">
                            ...
                            <p class="content-text white text-start">Illuminate your smile with our professional teeth whitening procedures. We specialize in removing
                                stains and discoloration, restoring the natural brilliance of your teeth. LINK.</p>
                        </div>
                    </div>
                    <div class="serv3-image-block">
                        ...
                        <div class="serv3-content-details fadeIn-bottom">
                            ...
                            <p class="content-text white text-start">Transform your smile with our custom-made porcelain veneers. These thin shells are expertly
