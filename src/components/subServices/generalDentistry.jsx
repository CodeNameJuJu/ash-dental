            ...
            <div class="row serv-top">
                ...
                <div class="col-5">
                    <div class="serv2-image-block">
                        <img class="serv2-image" src="/Images/ServicesLandscape/TeethWhitening.png" alt="2 description"></img>
...
disinfection, and the sealing of the root canal.
                    ...
                    <br/>
                    <h3>Mouthguards and Nightguards:</h3>
                    ...
                    <p class="lead text-start">We understand that dental emergencies can happen unexpectedly, causing
