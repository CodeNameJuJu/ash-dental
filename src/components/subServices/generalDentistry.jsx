        ...
        <div>
            ...
            <div className='row top-pad'>
                <div className='col-md-8 col-sm-12'>
                    <h1 className="gold text-start">Comprehensive General Dentistry</h1>
                    <h3 className="brown text-start ">Personalized Care for Optimal Oral Health</h3>
                    <br />
                    <p className="lead text-start">Experience personalised care and optimal oral health with our comprehensive range of general
                    ...
                    <br />
                    <p className="lead text-start">From dental restorations to general maintenance, we ensure
                        that every aspect of your oral health is meticulously addressed.</p>
                    <br />
                </div>
                <CdnImage className='col-md-4 col-sm-12 mb-md-0 mb-3 img-text-spacing' src="https://ik.imagekit.io/siftan/Images/FacesCloseUpsPortrait/8.webp" alt="Comprehensive General Dentistry" loading="lazy" style={{ height: '490px' }} />
            </div>
            &nbsp;
            <br></br>
            ...
            <div className="row serv-top text-center">
                ...
                <h3 className="brown text-start" >Routine Check-ups and Cleanings:</h3>
                <p className="lead text-start"> Routine Check-ups and Cleanings are more than just
                ...
                <br></br>
                <h3 className="gold text-start ">Root Canal Therapy:</h3>
                <h4 className="brown text-start"> Journey to a Confident Smile</h4>
                &nbsp;
                <p className="lead text-start"> Experience advanced Endodontic treatments at ASH Dental, where we redefine
                ...
                &nbsp;
                <h4 className="brown text-start">Root Canal Treatments</h4>
                <h6 className="brown text-start">Dealing with a bad toothache? It might be time for a root canal treatment! Here’s everything you need to know: </h6>
                &nbsp;
                <h5 className="brown text-start">What is a Root Canal?</h5>
                <p className="lead text-start">
                ...
                &nbsp;
                <h5 className="brown text-start">When is it Needed?</h5>
                <p className="lead text-start">
                ...
                <h5 className="brown text-start">The Procedure:</h5>
                <p className="lead text-start">
                    <ol>
                ...
                <h5 className="brown text-start">Benefits of Root Canal Treatment:</h5>
                <p className="lead text-start">
                    ...
                    &nbsp;
                <h5 className="brown text-start">Aftercare Tips:</h5>
                <p className="lead text-start">
                    <ol className="nonumber">
                ...
                <div className="dental-img">
                    <CdnImage className='col-md-2 col-sm-12 mb-md-0 mb-3' src="https://ik.imagekit.io/siftan/Images/ServicesLandscape/RootCanal.jpg" alt="Root canal treatment" loading="lazy" style={{ height: '100%' }} />
                    <CdnImage className='col-md-2 col-sm-12 mb-md-0 mb-3' src="https://ik.imagekit.io/siftan/Images/ServicesLandscape/RootCanal 2.jpg" alt="Root canal procedure" loading="lazy" style={{ height: '100%' }} />
                    </div>
                <br></br>
                &nbsp;
                <br></br>
                <h3 className="brown text-start">Tooth Extractions:</h3>
                <p className="lead text-start"> Our tooth extraction procedures ensure a seamless and comfortable process.
                ...
                &nbsp;
                <br></br>
                <h3 className="brown text-start">Dental Restorations:</h3>
                <p className="lead text-start"> We offer a range of dental restorations, including fillings, crowns, bridges, and
                ...
                &nbsp;
                <br></br>
                <h3 className="brown text-start">Gum Disease Treatment:</h3>
                <p className="lead text-start"> Early detection and intervention are key in managing gum disease. We go
                ...
                <h3 className="brown text-start">Mouthguards and Nightguards:</h3>
                <p className="lead text-start"> Customized mouthguards and nightguards provide protection
            ...
            <div className="row serv-top text-center">
                <h3 className="brown text-start" >Wisdom Teeth Management:</h3>
                <p className="lead text-start"> Our specialized care for wisdom teeth ensures their removal is as comfortable and efficient as
                ...
                <br></br>
                &nbsp;
                <h3 className="brown text-start">Denture Expertise:</h3>
                <p className="lead text-start "> Our team is skilled in providing denture solutions that restore smiles and functionality. ASH Dental&#39;s
