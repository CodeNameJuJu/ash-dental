        ...
        <div>
            ...
            <div className='row top-pad'>
                <div className='col-md-8 col-sm-12'>
                    <h1 className="gold text-start">Dental Implants</h1>
                    <h3 className="brown text-start ">Journey to a Confident Smile</h3>
                    <br />
                    <p className="lead text-start">Dental implants are more than just a procedure; they represent a transformative journey to restore
                        your confident smile.</p>
                    <br />
                    <p className="lead text-start">Dental implants are innovative solutions to restore missing teeth. Implants work by securely
                ...
                <CdnImage className='col-md-4 col-sm-12 mb-md-0 mb-3 img-text-spacing' src="https://ik.imagekit.io/siftan/Images/Dental/1.webp" alt="Dental Implants" loading="lazy" style={{ height: '100%' }} />
            </div>
            &nbsp;
            &nbsp;
            <div className='row'>
                <div className='col-md-12 col-sm-12'>
                    <h3 className="gold text-start">Regain Your Smile with Confidence: Your journey to Dental Implants</h3>
                    <p className="lead text-start">Missing teeth can significantly impact your life, causing discomfort while eating, speaking, and affecting your self-esteem.
                    ...
                    <br></br>
                    &nbsp;
                    <h5 className="text-color-gold text-start ">Understanding Dental Implants:</h5>
                    <p className="lead text-start">Dental implants are tiny, biocompatible titanium posts strategically placed within your bone through a surgical procedure.
                    ...
                    <br></br>
                    <br></br>
                    <h5 className="text-color-gold text-start ">A Solution for Missing Teeth:</h5>
                    <p className="lead text-start">Dental implants address several challenges associated with missing teeth:</p>
                    <br></br>
                    ...
                    &nbsp;
                    <h5 className="text-color-gold text-start ">What to Expect with Dental Implants:</h5>
                    <p className="lead text-start">The dental implant process typically involves multiple stages:</p>
                    <br></br>
                    <ol className="nonumber">
                    ...
                    <br></br>
                    <h5 className="text-color-gold text-start ">Considering Dental Implants?</h5>
                    <p className="lead text-start">If you're seeking a permanent and natural-looking solution for missing teeth, dental implants offer a life-changing
                        ...
                        healthy smile.</p>
                    <br></br>
                    <p className="lead text-start" >At
                    ...
                    <br />
                    <p className="lead text-start gold">Your journey to a radiant smile is marked by excellence, comfort, and results that redefine dental
                        care… because detail matters.</p>
                    <br />
                </div>
                <div className="dental-img">
                    <CdnImage className='col-md-2 col-sm-12 mb-md-0 mb-3' src="https://ik.imagekit.io/siftan/Images/ServicesLandscape/xraydepth.jpg" alt="Software for Implant" loading="lazy" style={{ height: '100%' }} />
                    <CdnImage className='col-md-2 col-sm-12 mb-md-0 mb-3' src="https://ik.imagekit.io/siftan/Images/ServicesLandscape/ImplantGuide.jpg" alt="Implant Guide" loading="lazy" style={{ height: '100%' }} />
                    <CdnImage className='col-md-2 col-sm-12 mb-md-0 mb-3' src="https://ik.imagekit.io/siftan/Images/ServicesLandscape/Implant.jpg" alt="Implant System" loading="lazy" style={{ height: '100%' }} />
                    <CdnImage className='col-md-2 col-sm-12 mb-md-0 mb-3' src="https://ik.imagekit.io/siftan/Images/ServicesLandscape/Crownimplant.jpg" alt="Implant Guide" loading="lazy" style={{ height: '100%' }} />
                    <CdnImage className='col-md-2 col-sm-12 mb-md-0 mb-3' src="https://ik.imagekit.io/siftan/Images/ServicesLandscape/xray.jpg" alt="Full Arch Rehabilitation" loading="lazy" style={{ height: '100%' }} />
                    </div>
            </div>
            &nbsp;
        </div>
