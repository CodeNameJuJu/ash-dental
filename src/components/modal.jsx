    ...
    <div className={`modal-move modal ${showModal ? 'show' : ''}`} tabIndex="-1" role="dialog" style={{ display: showModal ? 'block' : 'none' }}>
      <div className="modal-dialog text-center">
        <div className="modal-content">
          ...
          <div className="modal-body bg-modal d-flex justify-content-center p-4">
            <div className="w-100" style={{ maxWidth: '450px' }}>
              <p className="text-center mb-4">Please fill in the form below, and we will get in contact as soon as possible to confirm your booking</p>
              <form className="text-color" ref={form} onSubmit={handleSubmit(sendEmail)}>
                ...
                <button disabled={isSubmitting} className="btn btn-bg btn-link w-100">
