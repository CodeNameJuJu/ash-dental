        ...
        <div className="container-fluid p-0">
            ...
            <div className='ps-4 ms-4 pe-4 me-4'>
                <div >
                    ...
                    <h3 class="brown text-start">Join Us for ClearCorrect Day at ASH Dental</h3>
                ...
                <div className='text-center ' >
                    <h1 className=' text-color-gold text-start'>Why choose ClearCorrect?</h1>
                    <br></br>
            ...
            &nbsp;
            <div className=' ps-4 ms-4 pe-4 me-4'>
                <h1 class="gold text-start">Potential Outcomes:</h1>
            ...
            &nbsp;
            <div className=' ps-4 ms-4 pe-4 me-4'>
                <h1 class="gold text-start">Book Your Spot Today!</h1>
