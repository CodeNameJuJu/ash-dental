...
function Navbar() {
  ...
  const toggleMoreAboutUs = () => setIsMoreAboutUsOpen(!isMoreAboutUsOpen);
  ...
  return (
    <>
      <nav
        ...
        ${scrolled ? 'navbar-scrolled' : 'navbar-transparent'}`} // 👈 dynamic class
        id="myTopnav"
      >
              ...
              <li className="nav-item nav-hover dropdown lowerdropw no-desk">
                ...
                {isMoreAboutUsOpen && (
                  <li className="nav-item natetext lower-drop no-desk">
                    ...
                    <li className="nav-item natetext lowerdropw">
